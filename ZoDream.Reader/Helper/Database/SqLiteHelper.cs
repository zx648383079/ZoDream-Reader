...
namespace ZoDream.Reader.Helper.Database
{
    /// <summary>  
    /// 对SQLite操作的类  
    ...
    public class SqLiteHelper
    {
        ...
        /// 连接字符串  
        /// </summary>  
        public static string ConnectionString => $"Data Source={AppDomain.CurrentDomain.BaseDirectory}\\ZoDream.db;Pooling=true;FailIfMissing=false";
