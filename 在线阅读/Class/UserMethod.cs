...
namespace 在线阅读.Class
{
    public class UserMethod
    {
        ...
        public List<BookModel> LoadBook()
        {
            ...
            string model = reader.GetText(GetFile(), "Model{", "}");
        ...
        {
            TxtReader reader = new TxtReader();
            string body = reader.GetText(GetFile(), "Body{", "}");
        ...
        public List<BookRegex> LoadRegex()
        {
            ...
            TxtReader reader = new TxtReader();
            string regex =TxtToText( reader.GetText(GetFile(), "Regex{", "}"));
        ...
        private void DownLoad()
        {
            ...
            for (int i = 0; i < _count; i++)
            {
                ...
                string content =book.Name+"\n"+htmlReader.GetContent(book.Url,Model.NowBookRegex.Content,Model.NowBookRegex.Replace)+"\n";
