    ...
    public partial class SetWindow : Window
    {
        ...
        private void SavaBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (_systemPage != null)
            {
                ...
                //config.Save();
                //ConfigurationManager.RefreshSection("appSettings");    //修改后立即生效

                string[] body = new string[] { _systemPage.FontComboBox.Text,
                    _systemPage.FontSizeTb.Text, _systemPage.FontColorTb.Text,_systemPage.BackgroundTb.Text};

                _method.SavaBody(body);
